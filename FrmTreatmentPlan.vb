...
Public Class FrmTreatmentPlan
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("@AreaID", cbTreatmentArea.SelectedValue)

            cmd.Parameters.AddWithValue("@PlannedSessions", numSessions.Value)

            cmd.Parameters.AddWithValue("@SessionIntervalWeeks", numInterval.Value)

            cmd.Parameters.AddWithValue("@DeviceID", cbDevice.SelectedValue)

            cmd.Parameters.AddWithValue("@StartDate", dtStartDate.Value.Date)

            cmd.Parameters.AddWithValue("@Status", cbStatus.Text)

            cmd.Parameters.AddWithValue("@Notes", txtPlanNotes.Text)
