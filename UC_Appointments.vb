...
Public Class UC_Appointments
    ...
    Private Sub LoadAppointments()
        ...
        Try
            ...
            Dim cmd As New SqlCommand("SELECT
                                            ...
                                            CONVERT(varchar(10), A.AppointmentDate, 111) AS 'التاريخ',
                                            CONVERT(varchar(5), A.AppointmentTime, 108) AS 'الوقت',
                                            A.Status AS 'الحالة',
                                            A.Notes AS 'ملاحظات'
                                       FROM Appointments A
            ...
            cmd.Parameters.AddWithValue("@FromDate", Date.Today.AddDays(-60))

            cmd.Parameters.AddWithValue("@ToDate", Date.Today.AddDays(+60))
    ...
    Private Sub LoadTodaySchedule()
        ...
        Try
            ...
            For Each row As DataRow In dt.Rows
                ...
                lblTime.Text = row("AppointmentTime").ToString
    ...
    Private Sub btnBetweenDates_Click(sender As Object, e As EventArgs) Handles btnBetweenDates.Click
